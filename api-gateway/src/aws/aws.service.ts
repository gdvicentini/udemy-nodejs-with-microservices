...
//arquivo antigo que não é necessário a partir do momento que se usa validação de Token com "Amazon Cognito" e biblioteca "Passport"
//o service será refatorado para entrada de config e service de "aws-cognito" e "aws-s3" para conseguir conectar o usuário e validar o Token, junto à pasta "auth"
