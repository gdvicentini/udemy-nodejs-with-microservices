...
export class DesafiosService {
    ...
    async criarDesafio(criarDesafioDto: CriarDesafioDto): Promise<Desafio> {
        ...
        const solicitanteEhJogadorDaPArtida = await criarDesafioDto.jogadores.filter(jogador => jogador._id == criarDesafioDto._id)
        ...
        if("categoriaDoJogador") {
            throw new BadRequestException(`O solicitante precisa estar registado em uma categoria!`)
        }
    ...
    async deletarDesafio(_id: string): Promise<void> {
        ...
        // Realizaremos a deleção lógica do desafio, modificando seus status para CANCELADO
